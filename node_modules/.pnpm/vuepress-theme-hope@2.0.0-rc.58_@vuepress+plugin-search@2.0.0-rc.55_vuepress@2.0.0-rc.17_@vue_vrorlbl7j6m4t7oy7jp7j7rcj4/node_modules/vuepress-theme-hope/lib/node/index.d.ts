...
type ThemeMarkdownHintPluginHelper = Helper<MarkdownHintPluginOptions | boolean>;
type ThemeMarkdownImagePluginHelper = Helper<MarkdownImagePluginOptions | boolean>;
type ThemeMarkdownMathPluginHelper = Helper<MarkdownMathPluginOptions | boolean>;
type ThemeMarkdownTabPluginHelper = Helper<MarkdownTabPluginOptions | boolean>;
...
declare const markdownHint: ThemeMarkdownHintPluginHelper;
declare const markdownImage: ThemeMarkdownImagePluginHelper;
declare const markdownMath: ThemeMarkdownMathPluginHelper;
declare const markdownTab: ThemeMarkdownTabPluginHelper;
 ...
 */
declare const getFeedPlugin: (themeData: ThemeData, options?: Omit<FeedPluginOptions, "hostname"> | boolean, hostname?: string, favicon?: string, legacy?: boolean) => Plugin | null;
 ...
 */
declare const getMarkdownHintPlugin: (options?: MarkdownHintPluginOptions | boolean) => Plugin | null;
 ...
 */
declare const getMarkdownImagePlugin: (options?: Partial<MarkdownImagePluginOptions> | boolean) => Plugin | null;
 ...
 */
declare const getMarkdownMathPlugin: (options?: Partial<MarkdownMathPluginOptions> | boolean) => Plugin | null;
 ...
 */
declare const getMarkdownTabPlugin: (options?: Partial<MarkdownTabPluginOptions> | boolean) => Plugin | null;
 ...
 */
declare const usePrismjsPlugin: (app: App, options?: PrismjsPluginOptions | true) => void;
/**
 * @private
 *
 ...
 */
declare const getRevealJsPlugin: (options?: Omit<RevealJsPluginOptions, "layout"> | boolean) => Plugin | null;
 ...
 */
declare const getSEOPlugin: (themeData: ThemeData, seo?: Omit<SeoPluginOptions, "hostname" | "author"> | boolean, hostname?: string) => Plugin | null;
